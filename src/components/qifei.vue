    ...
    <div class="ge">
      <template>
        ...
        >
          ...
          <el-table-column prop="ru" label="入库时间" show-overflow-tooltip>
          </el-table-column>
          <el-table-column prop="bao" label="报废时间" show-overflow-tooltip>
          </el-table-column>
          <el-table-column prop="shen" label="审批状态" show-overflow-tooltip>
          </el-table-column>
