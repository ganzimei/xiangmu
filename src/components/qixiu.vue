    ...
    <div class="ge">
      <template>
        ...
        >
          ...
          <el-table-column prop="shu" label="报修数量" show-overflow-tooltip>
          </el-table-column>
          <el-table-column prop="gui" label="规格" show-overflow-tooltip>
          </el-table-column>
          <el-table-column prop="baoo" label="报修时间" show-overflow-tooltip>
          </el-table-column>
          <el-table-column prop="zhuang" label="修理状态" show-overflow-tooltip>
          </el-table-column>
          <el-table-column prop="shi" label="修理时间" show-overflow-tooltip>
          </el-table-column>
          <el-table-column prop="wei" label="维修花销" show-overflow-tooltip>
          </el-table-column>
          <el-table-column prop="pi" label="审批状态" show-overflow-tooltip>
          </el-table-column>
          <el-table-column prop="cao" label="操作" show-overflow-tooltip>
          </el-table-column>
        </el-table>
      </template>
      <el-row>
