<template>
  <div class="ruku">
    ...
    <div class="biao">
      ...
      <el-row>
        <el-button class="cha" @click="searchInput(input)">查询</el-button>
      </el-row>
      <el-row>
    ...
    <div class="ge">
      <template>
        ...
        >
          ...
          <el-table-column prop="shu" label="数量" show-overflow-tooltip>
          </el-table-column>
          <el-table-column prop="gui" label="规格" show-overflow-tooltip>
          </el-table-column>
          <el-table-column prop="cun" label="存放地点" show-overflow-tooltip>
          </el-table-column>
          <el-table-column prop="shi" label="是否唯一" show-overflow-tooltip>
          </el-table-column>
          <el-table-column prop="ku" label="入库时间" show-overflow-tooltip>
          </el-table-column>
          <el-table-column prop="shang" label="上报状态" show-overflow-tooltip>
          </el-table-column>
      ...
      <el-row>
        <el-button class="bao">数据上报</el-button>
      </el-row>
      <el-row>
        <el-button class="bao1">查看上报记录</el-button>
      </el-row>
      <div class="ye">
        <p>共5页，每页展示10条</p>
        <el-pagination
  ...
  methods: {
    ...
    activated() {
        if (this.$route.params.items) {
            this.$route.params.items.date = this.tableData.length + 1;
